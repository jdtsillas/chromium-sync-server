...
_DEPRECATEDMESSAGE = _descriptor.Descriptor(
  name='DeprecatedMessage',
  full_name='sync_pb.DeprecatedMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_SYNCCYCLECOMPLETEDEVENTINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='get_updates_origin', full_name='sync_pb.SyncCycleCompletedEventInfo.get_updates_origin', index=10,
...
_SYNCCYCLECOMPLETEDEVENTINFO.fields_by_name['caller_info'].message_type = get__updates__caller__info__pb2._GETUPDATESCALLERINFO
_SYNCCYCLECOMPLETEDEVENTINFO.fields_by_name['source_info'].message_type = _DEPRECATEDMESSAGE
_SYNCCYCLECOMPLETEDEVENTINFO.fields_by_name['get_updates_origin'].enum_type = sync__enums__pb2._SYNCENUMS_GETUPDATESORIGIN
_DEBUGEVENTINFO.fields_by_name['singleton_event'].enum_type = sync__enums__pb2._SYNCENUMS_SINGLETONDEBUGEVENTTYPE
...
DESCRIPTOR.message_types_by_name['DeprecatedMessage'] = _DEPRECATEDMESSAGE
...
TypeHint = _reflection.GeneratedProtocolMessageType('TypeHint', (_message.Message,), dict(
  DESCRIPTOR = _TYPEHINT,
  __module__ = 'client_debug_info_pb2'
  # @@protoc_insertion_point(class_scope:sync_pb.TypeHint)
  ))
_sym_db.RegisterMessage(TypeHint)

DeprecatedMessage = _reflection.GeneratedProtocolMessageType('DeprecatedMessage', (_message.Message,), dict(
  DESCRIPTOR = _DEPRECATEDMESSAGE,
  __module__ = 'client_debug_info_pb2'
  # @@protoc_insertion_point(class_scope:sync_pb.DeprecatedMessage)
  ))
_sym_db.RegisterMessage(DeprecatedMessage)

SyncCycleCompletedEventInfo = _reflection.GeneratedProtocolMessageType('SyncCycleCompletedEventInfo', (_message.Message,), dict(
...
DatatypeAssociationStats = _reflection.GeneratedProtocolMessageType('DatatypeAssociationStats', (_message.Message,), dict(
...
DebugEventInfo = _reflection.GeneratedProtocolMessageType('DebugEventInfo', (_message.Message,), dict(
...
_SYNCCYCLECOMPLETEDEVENTINFO.fields_by_name['source_info']._options = None
