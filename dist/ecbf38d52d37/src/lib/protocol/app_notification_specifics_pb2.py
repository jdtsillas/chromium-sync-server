...
AppNotification = _reflection.GeneratedProtocolMessageType('AppNotification', (_message.Message,), dict(
  DESCRIPTOR = _APPNOTIFICATION,
  __module__ = 'app_notification_specifics_pb2'
  # @@protoc_insertion_point(class_scope:sync_pb.AppNotification)
  ))
_sym_db.RegisterMessage(AppNotification)
