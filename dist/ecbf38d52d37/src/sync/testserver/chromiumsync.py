...
from lib.protocol import app_list_specifics_pb2
from lib.protocol import app_notification_specifics_pb2
from lib.protocol import app_setting_specifics_pb2
from lib.protocol import app_specifics_pb2
from lib.protocol import arc_package_specifics_pb2
from lib.protocol import article_specifics_pb2
from lib.protocol import autofill_specifics_pb2
from lib.protocol import bookmark_specifics_pb2
from lib.protocol import client_commands_pb2
from lib.protocol import client_debug_info_pb2
from lib.protocol import device_info_specifics_pb2
from lib.protocol import dictionary_specifics_pb2
from lib.protocol import encryption_pb2
from lib.protocol import experiments_specifics_pb2
from lib.protocol import extension_setting_specifics_pb2
from lib.protocol import extension_specifics_pb2
from lib.protocol import favicon_image_specifics_pb2
from lib.protocol import favicon_tracking_specifics_pb2
from lib.protocol import get_updates_caller_info_pb2
from lib.protocol import history_delete_directive_specifics_pb2
from lib.protocol import managed_user_setting_specifics_pb2
from lib.protocol import managed_user_specifics_pb2
from lib.protocol import managed_user_shared_setting_specifics_pb2
from lib.protocol import managed_user_whitelist_specifics_pb2
from lib.protocol import mountain_share_specifics_pb2
from lib.protocol import nigori_specifics_pb2
from lib.protocol import password_specifics_pb2
from lib.protocol import preference_specifics_pb2
from lib.protocol import printer_specifics_pb2
from lib.protocol import priority_preference_specifics_pb2
from lib.protocol import reading_list_specifics_pb2
from lib.protocol import search_engine_specifics_pb2
from lib.protocol import send_tab_to_self_specifics_pb2
from lib.protocol import session_specifics_pb2
from lib.protocol import sync_pb2
from lib.protocol import sync_enums_pb2
from lib.protocol import synced_notification_app_info_specifics_pb2
from lib.protocol import synced_notification_specifics_pb2
from lib.protocol import theme_specifics_pb2
from lib.protocol import typed_url_specifics_pb2
from lib.protocol import unique_position_pb2
from lib.protocol import user_consent_specifics_pb2
from lib.protocol import user_event_specifics_pb2
from lib.protocol import wifi_credential_specifics_pb2
...
class SyncDataModel(object):
  ...
  def _CheckParentIdForCommit(self, entry):
    ...
    if entry.parent_id_string == ROOT_ID:
      ...
      return True
    if (entry.HasField('parent_id_string') and
        entry.HasField('originator_cache_guid')):
      return True
